...
| `QTC_L9_th0.5236_n200` | Quantum Tensor Chain | Z_3^2 x Z_2 | L=9, theta=pi/6, 200 samples |
| `QTC_L9_th0.7854_n200` | Quantum Tensor Chain | Z_3^2 x Z_2 | L=9, theta=pi/4, 200 samples |
